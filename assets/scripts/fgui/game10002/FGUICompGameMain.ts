...
export default class FGUICompGameMain extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.UI_COMP_PLAYERS = <FGUICompPlayers>(this.getChildAt(2));
		this.UI_COMP_MAP = <FGUICompMap>(this.getChildAt(3));
		this.UI_BTN_INVITE = <fgui.GButton>(this.getChildAt(4));
		this.UI_BTN_INVITE.onClick(this.onBtnInvite, this);
		this.UI_BTN_START_GAME = <fgui.GButton>(this.getChildAt(5));
		this.UI_BTN_START_GAME.onClick(this.onBtnStartGame, this);
		this.UI_COMP_SELFPLAYER = <FGUICompPlayerHead>(this.getChildAt(7));
		this.UI_COMP_SELF_MEDAL = <fgui.GComponent>(this.getChildAt(8));
