...
export default class FGUICompTimeStar extends fgui.GLabel {

	public ctrl_stars:fgui.Controller;
	public static URL:string = "ui://2zsfe53xkq4j1z";
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10002", "CompTimeStar") as FGUICompTimeStar;

			view.makeFullScreen();
			FGUICompTimeStar.instance = view;
...
fgui.UIObjectFactory.setExtension(FGUICompTimeStar.URL, FGUICompTimeStar);