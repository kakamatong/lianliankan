...
export default class FGUICompVoteInfo extends fgui.GComponent {
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10002", "CompVoteInfo") as FGUICompVoteInfo;
	...
	public static createInstance():FGUICompVoteInfo {
		return <FGUICompVoteInfo>(fgui.UIPackage.createObject("game10002", "CompVoteInfo"));
	}
