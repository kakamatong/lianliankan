...
export default class FGUICompDisband extends fgui.GComponent {
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10002", "CompDisband") as FGUICompDisband;
	...
	public static createInstance():FGUICompDisband {
		return <FGUICompDisband>(fgui.UIPackage.createObject("game10002", "CompDisband"));
	}
