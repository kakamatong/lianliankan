...
export default class FGUICompOffline extends fgui.GComponent {
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10002", "CompOffline") as FGUICompOffline;
	...
	public static hideView():void {
		if (!FGUICompOffline.instance) return;
		if (FGUICompOffline.enableAnimation) {
			FGUICompOffline.instance.hideAnimation();
			return;
		}
		FGUICompOffline.instance.dispose();
	}
