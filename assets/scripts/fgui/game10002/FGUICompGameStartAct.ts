...
export default class FGUICompGameStartAct extends fgui.GComponent {
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10002", "CompGameStartAct") as FGUICompGameStartAct;
	...
	public static hideView():void {
		if (!FGUICompGameStartAct.instance) return;
		if (FGUICompGameStartAct.enableAnimation) {
			FGUICompGameStartAct.instance.hideAnimation();
			return;
		}
		FGUICompGameStartAct.instance.dispose();
	}
	...
	public static createInstance():FGUICompGameStartAct {
		return <FGUICompGameStartAct>(fgui.UIPackage.createObject("game10002", "CompGameStartAct"));
	}

	protected onConstruct():void {
		this.act = this.getTransitionAt(0);
		if (FGUICompGameStartAct.enableAnimation) this.enterAnimation();
	}
