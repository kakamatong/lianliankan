...
export default class FGUICompRoundAct extends fgui.GComponent {
	...
	public static showView(params?:any, callBack?:(b:boolean)=>void):void {
		...
		PackageManager.instance.loadPackage("fgui", this.packageName).then(()=> {
			...
			const view = fgui.UIPackage.createObject("game10002", "CompRoundAct") as FGUICompRoundAct;
	...
	public static createInstance():FGUICompRoundAct {
		return <FGUICompRoundAct>(fgui.UIPackage.createObject("game10002", "CompRoundAct"));
	}
